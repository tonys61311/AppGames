...
// class MahJongPageState extends State<MahJongPage> {
...
//   void initState() {
//     super.initState();
//     _mahJongBloc = BlocProvider.of<MahJongBloc>(context);
//     doShuffle(); // 初始化時進行洗牌
//   }
//
//   void doShuffle() {
...
//       AudioPlayer player = await mainPlayer.play('8002.mp3'); // 播放音效
//       Timer.periodic(Duration(milliseconds: 300), (timer) {
//         if (time > 4000) {
//           timer.cancel();
//           start = true;
//           player.stop();
//           player.play('shuffle.mp3'); // 播放洗牌音效
...
//                                   Row(
//                                     children: [
//                                       for(var i=0;i<_mahJongBloc.aAnswer.length;i++)
//                                         Mahjong(
//                                           margin: EdgeInsets.only(left: 4,right: 4),
//                                           width: 60,
//                                           height: 70,
//                                           back: false,
//                                           model: _mahJongBloc.aAnswer[i],
//                                           hasDel: true,
//                                           onDel: (){
//                                             //刪除
//                                             MJModel mod = _mahJongBloc.aAnswer[i];
//                                             _mahJongBloc.aAnswer.removeWhere((e) => e.type == mod.type && e.num == mod.num);
//                                             _mahJongBloc.add(CheckAnswer(role: 'A'));
//                                           },
//                                         ),
//                                     ],
//                                   )
...
//                                 if(_mahJongBloc.aAnswer.every((e) => e.type != model.type || e.num != model.num)){
//                                   _mahJongBloc.aAnswer.add(model);
//                                 }
//                                 _mahJongBloc.add(CheckAnswer(role: 'A'));
//                               },
//                             ),
...
//                             Row(
//                               children: [
//                                 for(var i=0;i<_mahJongBloc.bAnswer.length;i++)
//                                   Mahjong(
//                                     margin: EdgeInsets.only(left: 4,right: 4),
//                                     width: 60,
//                                     height: 70,
//                                     back: false,
//                                     model: _mahJongBloc.bAnswer[i],
//                                     hasDel: true,
//                                     onDel: (){
//                                       //刪除
//                                       MJModel mod = _mahJongBloc.bAnswer[i];
//                                       _mahJongBloc.bAnswer.removeWhere((e) => e.type == mod.type && e.num == mod.num);
//                                       _mahJongBloc.add(CheckAnswer(role: 'B'));
//                                     },
//                                   ),
//                               ],
//                             )
...
//                       ChoiseCard(
//                         onConfirm: (MJModel model){
//                           if(_mahJongBloc.bAnswer.every((e) => e.type != model.type || e.num != model.num)){
//                             _mahJongBloc.bAnswer.add(model);
//                           }
//                           _mahJongBloc.add(CheckAnswer(role: 'B'));
//                         },
//                       ),
